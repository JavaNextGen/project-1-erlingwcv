...
////		//public Handler loginRequestHandler = (ctx) -> {
//		
//		User uToDao = new User();            
		// First, input to: AuthService as = new AuthService(), back here with output to DB
		// Second, AU process 2.1 call UserDAO user insert, 2.2 get output and process it and ouput it back to here
		// Third, send the selective info to frontend
//		
//		User uToJS = new User();  // Second, selective info packed for frontend after verification
